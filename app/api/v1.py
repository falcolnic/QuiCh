...
from app.api import login, transcript
...
unauthenticated_api_router.include_router(login.router, tags=["Login"])
...
api_router = APIRouter(prefix=app_config.API_PREFIX, default_response_class=JSONResponse)

api_router.include_router(unauthenticated_api_router)
api_router.include_router(authenticated_api_router, dependencies=[PROTECTED])